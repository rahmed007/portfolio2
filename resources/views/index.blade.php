...
<html lang="en">
    <head>
        ...
        <link href="{{asset('assects/css/bootstrap.min.css')}}" rel="stylesheet">

        <link href="{{asset('assects/css/bootstrap-icons.css')}}" rel="stylesheet">

        <link href="{{asset('assects/css/magnific-popup.css')}}" rel="stylesheet">

        <link href="{{asset('assects/css/templatemo-first-portfolio-style.css')}}" rel="stylesheet">
...
-->
    ...
    <body>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="hero-text">
                                <div class="hero-title-wrap d-flex align-items-center mb-4">
                                    <img src="{{asset('assects/images/happy-bearded-young-man.jpg')}}" class="avatar-image avatar-image-large img-fluid" alt="">
                        ...
                        <div class="col-lg-5 col-12 position-relative">
                            ...
                            <img src="{{asset('assects/images/portrait-happy-excited-man-holding-laptop-computer.png')}}" class="hero-image img-fluid" alt="">
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="{{asset('assects/images/couple-working-from-home-together-sofa.jpg')}}" class="about-image img-fluid" alt="">
                        </div>
                        ...
                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            <div class="about-thumb">
                                ...
                                <div class="section-title-wrap d-flex justify-content-end align-items-center mb-4">
                                    ...
                                    <img src="{{asset('assects/images/happy-bearded-young-man.jpg')}}" class="avatar-image img-fluid" alt="">
                                </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-4 ms-auto clients-item-height">
                            <img src="{{asset('assects/images/clients/cachet.svg')}}" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 clients-item-height">
                            <img src="{{asset('assects/images/clients/guitar-center.svg')}}" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 clients-item-height">
                            <img src="{{asset('assects/images/clients/tokico.svg')}}" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 clients-item-height">
                            <img src="{{asset('assects/images/clients/shopify.sv')}}'" class="clients-image img-fluid" alt="">
                        </div>

                        <div class="col-lg-2 col-4 me-auto clients-item-height">
                            <img src="{{asset('assects/images/clients/profil-rejser.svg')}}" class="clients-image img-fluid" alt="">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-12 mx-auto">
                            <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                                <img src="{{asset('assects/images/handshake-man-woman-after-signing-business-contract-closeup.jpg')}}" class="avatar-image img-fluid" alt="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-12 ms-auto">
                            <div class="section-title-wrap d-flex justify-content-center align-items-center mb-4">
                                <img src="{{asset('assects/images/white-desk-work-study-aesthetics.jpg')}}" class="avatar-image img-fluid" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                ...
                                <a href="{{asset('assects/images/projects/nikhil-KO4io-eCAXA-unsplash.jpg')}}" class="popup-image">
                                    <img src="{{asset('assects/images/projects/nikhil-KO4io-eCAXA-unsplash.jpg')}}" class="projects-image img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                ...
                                <a href="{{asset('assects/images/projects/the-5th-IQYR7N67dhM-unsplash.jpg')}}" class="popup-image">
                                    <img src="{{asset('assects/images/projects/the-5th-IQYR7N67dhM-unsplash.jpg')}}" class="projects-image img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                ...
                                <a href="{{asset('assects/images/projects/true-agency-9Bjog5FZ-oc-unsplash.jpg')}}" class="popup-image">
                                    <img src="{{asset('assects/images/projects/true-agency-9Bjog5FZ-oc-unsplash.jpg')}}" class="projects-image img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-8 col-12">
                                <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                                    <img src="{{asset('assects/images/aerial-view-man-using-computer-laptop-wooden-table.jpg')}}" class="avatar-image img-fluid" alt="">
        ...
        <!-- JAVASCRIPT FILES -->
        <script src="{{asset('assects/js/jquery.min.js')}}"></script>
        <script src="{{asset('assects/js/bootstrap.min.js')}}"></script>
        <script src="{{asset('assects/js/jquery.sticky.js')}}"></script>
        <script src="{{asset('assects/js/click-scroll.js')}}"></script>
        <script src="{{asset('assects/js/jquery.magnific-popup.min.js')}}"></script>
        <script src="{{asset('assects/js/magnific-popup-options.js')}}"></script>
        <script src="{{asset('assects/js/custom.js')}}"></script>
